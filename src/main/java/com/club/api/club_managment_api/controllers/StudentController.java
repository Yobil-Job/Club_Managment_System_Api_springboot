...
public class StudentController {
	...
	public ResponseEntity<EntityModel<StudentResponseDto>> registerStudentGlobal(@Valid @RequestBody StudentRequestDto dto) {
	...
	public ResponseEntity<EntityModel<StudentResponseDtoFull>> retriveStudentById(@PathVariable long id) {
		...
		EntityModel<StudentResponseDtoFull> response=EntityModel.of(student, 
				...
				linkTo(methodOn(StudentController.class).updateStudentInfo(student.getId(), dto)).withRel("update_info"));
	...
	public ResponseEntity<CollectionModel<EntityModel<StudentResponseDto>>> retriveAllStudents() {
		...
		List<EntityModel<StudentResponseDto>> e = studentService.getAllStudents().stream()
				.map(student -> EntityModel.of(student,
						...
						linkTo(methodOn(StudentController.class).getEventsAttended(student.getId())).withRel("events_Atended"),
	...
	public StudentResponseDtoFull updateStudentInfo(@PathVariable long id,@Valid @RequestBody StudentRequestDtoFull dto ) {
	...
	/*
	 * @PostMapping("/{id}/clubs/joinclub") public
	 * ResponseEntity<EntityModel<StudentResponseDtoFull>> joinClub(@PathVariable
	 * long id,@RequestParam int clubId) { StudentResponseDtoFull s=
	 * studentService.joinClub(id, clubId); EntityModel<StudentResponseDtoFull>
	 * response=EntityModel.of(s,
	 * linkTo(methodOn(StudentController.class).getClubs(id)).withRel("clubs"));
	 * return ResponseEntity.ok(response); }
	 */
 ...
 * 
 * 
 * GET /api/students/{id}/authorities → getAuthoritiesHeld
 * 
 * GET /api/students/{id}/announcements → getAnnouncementsCreated
 */